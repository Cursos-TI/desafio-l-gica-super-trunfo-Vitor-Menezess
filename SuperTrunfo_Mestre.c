...
// Calcular o super poder
        ...
        Superpoder2 = Populacao2 + Area2 + PIB2 + Pontos_turisticos2 + PIBpercapita2 + (1 /Densipopulacional2);
                    ...
                    // Impressão do primeiro menu de escolhas de atributo
                    ...
                    // Impressão do segundo menu de escolhas de atributo
                    ...
                    // Impressão do terceiro menu de escolhas de atributo
                            ...
                            scanf("%d", &AtributoComparacao4);
                                ...
                                && (AtributoComparacao2 == AtributoComparacao4)){
                                    ...
                                    case 1:
                                        ...
                                        //Impreção do nome do estado de cada carta 
